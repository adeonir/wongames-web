import { parseQueryStringToSearch, parseQueryStringToFilter } from '.'
...
describe('parseQueryStringToSearch', () => {
  it('should parse the queryString to JSON format', () => {
    const parsedQuery = parseQueryStringToSearch({ queryString, filterItems })
...
describe('parseQueryStringToFilter', () => {
  it('should parse the queryString to query string', () => {
